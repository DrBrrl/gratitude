...
![A visitor signs in to their private journal](./screenshots/000-google-signin-desktop-chromium.png)
...
![A reflection is saved to the signed-in account](./screenshots/001-saved-reflection-desktop-chromium.png)
...
![The same journal survives reload and complete projection rebuild](./screenshots/002-replayed-reflection-desktop-chromium.png)
